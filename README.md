...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-06 17:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5dece012-a020-411e-96cd-c972abf3c67f.git
$ cd 5dece012-a020-411e-96cd-c972abf3c67f
```
